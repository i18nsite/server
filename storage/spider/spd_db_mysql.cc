...
int spider_mbase_handler::append_multi_range_cnt_with_name(
  ...
  range_cnt_length = snprintf(range_cnt_str, sizeof(range_cnt_str),
                              "%u", multi_range_cnt);
